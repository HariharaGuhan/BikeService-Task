            ...
            <div className='container-fluid'>
                <div className="row ">
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                            ...
                            <div className='search1'>
                                ...
                                <form className="form-inline d-flex flex-row searchbox">
                                    <input className="form-control mr-sm-2 seacrhinput" id="searchbox1" type="search" placeholder="Search" aria-label="Search" />
                            ...
                            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                                ...
                                <div className='search2'>
                                    <form className="form-inline my-2 my-lg-0 d-flex flex-row searchbox">
                                        <input className="form-control mr-sm-2 seacrhinput" id="searchbox2" type="search" placeholder="Search"  aria-label="Search" />
                                        <button className="searchbutton" type="submit">Search</button>
                                    </form>
                                </div>
                                <ul className="navbar-nav mr-auto">
                    ...
                    <div className='search3'>
                        <form className="form-inline my-2 my-lg-0 d-flex flex-row searchbox">
                            <input className="form-control mr-sm-2 seacrhinput" id="searchbox3" type="search" placeholder="Search"  aria-label="Search" />
                            <button className="searchbutton" type="submit">Search</button>
                        </form>
                    </div>
                </div>
